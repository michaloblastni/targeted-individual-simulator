...
# Physical design
$5 electronics can implement the sense, reason and act framework. It is an offlice voice recognition agent that reasons and acts (incl. by responding with text to voice): 
